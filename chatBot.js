function chat(){
    ...
    nobutton.onclick = function() {
        document.getElementById("chatbox").innerHTML += "<br>" + "Would you like to generate a ticket?";
    }
    document.getElementById("chatbox").innerHTML += "<br>" +"User:  "  + inputVal + "<br>";
    document.getElementById("chatbox").innerHTML += "<br>" +"Chatbot: Generating results for "  + inputVal + "<br>" +"Chatbot: Did that answer your question?" + "<br>";
